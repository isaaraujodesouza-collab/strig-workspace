---
name: feedback_strignews-escrita
description: Regras de escrita da Strig News confirmadas pela Isa — o que evitar e o que sempre fazer nos artigos da newsletter
metadata: 
  node_type: memory
  type: feedback
...
**Why:** Quebra o fluxo de leitura e não agrega para o leitor médio da newsletter.
**How to apply:** Substituir por "o projeto", "o processo", "o acordo" — ou simplesmente omitir. Exceção: quando o número for o próprio elemento notícia (ex: "multa de R$20 mil/dia").

Sempre traduzir títulos de cargos em inglês para o português.
**Why:** Termos como "chief hardware officer", "chief revenue officer" etc. criam tropeço na leitura.
**How to apply:** "Chief hardware officer" → "diretor de hardware". "Chief executive officer" → CEO é aceito (sigla consagrada). Cargos funcionais sempre em português: "diretor", "vice-presidente", "chefe".

Quando um nome de empresa ou iniciativa for pouco conhecido, explicar brevemente o que é na primeira menção.
**Why:** "io Products" sem contexto não faz sentido para o leitor.
**How to apply:** "a io Products, empresa de hardware fundada por Jony Ive" — contexto em aposição, sem abrir parágrafo separado só para isso.
