...
## MENU (âncoras)
HERO · Tratamentos · Diferenciais · Depoimentos · Localização e contato · Quem somos · Formulário · FAQ
...
**CTA:** nenhum nesta dobra (institucional, sem botão de ação no primeiro scroll).
...
**TÍTULO DA DOBRA:**
Como funciona o atendimento na Jeff Souza Odontologia

**SUBTÍTULO:**
Antes de qualquer procedimento, existe um processo. Ele é o mesmo pra todo paciente, independente do histórico anterior.
...
**3. Diagnóstico explicado**
Entrega de um documento de diagnóstico com o que foi encontrado e o plano de tratamento indicado, sempre explicado antes de qualquer decisão.

**4. Encaminhamento, se for o caso**
...
**7. Documentação do fim do tratamento**
Registro fotográfico do resultado e orientação de manutenção.

*Este processo é o mesmo independente do paciente já ter feito tratamento em outra clínica antes.*
...
### DOBRA 3A — CONSULTA DE DIAGNÓSTICO COMPLETA
...
- Condições sistêmicas como diabetes e hipertensão
- Histórico familiar de câncer de boca, língua, garganta ou gengiva
- HPV e HIV
- Gravidez
...
- Protocolo, reabilitação total apoiada em implantes

*[Espaço para fotos: casos de reabilitação oral, início e fim de tratamento, apenas com autorização por escrito]*

**CTA:** nenhum nesta dobra.

---

### DOBRA 3C — PREVENÇÃO E ACOMPANHAMENTO CONTÍNUO
...
**TÍTULO:**
Procedimentos cirúrgicos, feitos com o parceiro cirurgião da equipe

**TEXTO:**
Quando o caso exige cirurgia, o paciente é encaminhado ao cirurgião parceiro da equipe. Ninguém faz tudo bem feito, por isso cada procedimento tem um especialista responsável.

**Cards (tratamentos dentro desta frente):**
- Extração simples
- Extração de dente do siso (terceiro molar incluso)
...
- Acompanhamento do crescimento em pacientes mais novos (ortodontia preventiva e interceptativa)

*[Espaço para fotos: casos de ortodontia, início e fim de tratamento, apenas com autorização por escrito]*

**CTA:** nenhum nesta dobra.

---

### DOBRA 3F — ENDODONTIA (CANAL)

**TÍTULO:**
Tratamento de canal, com o endodontista parceiro

**TEXTO:**
Quando o caso é de canal, o paciente é encaminhado ao endodontista da equipe. O acompanhamento continua próximo mesmo depois do encaminhamento.

**Cards (tratamentos dentro desta frente):**
- Tratamento de canal, unirradicular e multirradicular
- Retratamento endodôntico
- Acompanhamento pós-tratamento

*[Espaço para fotos: casos de canal, como o paciente chegou e como o tratamento foi finalizado]*
...
## DOBRA 5 — O QUE VOCÊ APRENDE NA CONSULTA
...
Esse tipo de orientação não é padrão em todo consultório. Aqui, faz parte do processo desde a primeira consulta.

**O que costuma ser ensinado:**
- Técnica correta de escovação, ajustada ao caso
...
**SUBTÍTULO:**
Preencha os dados abaixo. A equipe entra em contato pra entender a sua situação antes de qualquer agendamento.

- **FORMULÁRIO PADRÃO** (nome, WhatsApp, e campo aberto opcional pra descrever o caso)
...
**CTA FINAL:**
Se a sua dúvida não está aqui, fale direto com a clínica.
"Falar com a clínica pelo WhatsApp" → WhatsApp

---

**Como posso agendar uma consulta e qual a antecedência recomendada?**
...
**A clínica possui acessibilidade para pessoas com deficiência? E como funciona o estacionamento?**
...
**A clínica atende crianças? Como funciona o atendimento infantil?**
Sim, para atendimentos básicos. Quando necessário, a criança é encaminhada pro especialista adequado.

**A clínica atende emergências? Quais os horários nesse caso?**
Emergências são avaliadas individualmente. Os horários são confirmados diretamente pelo WhatsApp.

**A clínica realiza tratamento mesmo quando não é estritamente necessário, se o paciente pedir?**
Não. Recusar tratamento desnecessário é um dos valores centrais da clínica, mesmo quando o paciente está disposto a pagar por ele.

*Nota: a pergunta sobre convênio (presente no roteiro original de FAQ) não entrou aqui porque a aceitação de convênio ainda não foi confirmada formalmente com o Jeff. As formas de pagamento respondidas acima (dinheiro, Pix, boleto, cartão) indicam atendimento particular, mas isso precisa ser confirmado antes de publicar como afirmação no site.*
...
© Jeff Souza Odontologia — Todos os direitos reservados
