...
Cuidado de forma: esse bloco fala de *tipo de necessidade*, o bloco do calendário (mais abaixo) fala de *época do ano* (SIPAT, convenção, confraternização). Manter os exemplos distintos nos dois blocos pra não repetir na escrita final.
