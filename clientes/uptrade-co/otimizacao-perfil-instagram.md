# Otimização de Perfil Instagram — UpTrade & Co

**Base:** modelo padrão de otimização de perfil da Strig (referência Braza Barbearia), adaptado de 6 destaques físicos para 5 destaques e 3 fixados, porque a UpTrade não tem loja, equipe numerosa nem localização pública pra mostrar.
**Fonte do conteúdo:** `copy-landing-page.md`, `faq-site.md` e `pesquisa-social.md`, todos já validados pra esse cliente.
**Convenção de pendência:** campos em `[colchetes]` seguem o mesmo padrão dos outros documentos da UpTrade, precisam de confirmação antes de publicar.

---

## Perfil

**Nome sugerido:** UpTrade & Co | Assessoria de Importação

> Diferente da Braza ("Braza Barbearia | Saúde, SP"), não anexei cidade ao nome. A UpTrade atende o Brasil inteiro, então localidade no nome soaria estranho ou até enganoso, e o Instagram, assim como o GMB, penaliza nome de perfil que não bate com a razão social. "Assessoria de Importação" cumpre o papel de dizer o que a marca faz, sem prometer geografia que não existe.
...
## Destaques — Sequências de Stories

### Sobre
História da UpTrade, sócias e propósito

**Tela 1**
Bem-vinda à UpTrade!
Antes de falar de importação, deixa a gente contar de onde viemos.
Passa pro lado pra saber!

**Tela 2**
A UpTrade nasceu em outubro de 2025, da união de Vanessa e Daniela, que já atuavam juntas na área comercial de uma importadora de utilidades domésticas antes de abrir a empresa.

**Tela 3**
A experiência não começou com a UpTrade. Veio de antes, e é ela que sustenta cada operação que a gente assessora hoje.

**Tela 4**
O que começou como representação comercial virou importação direta, porque os clientes precisavam de mais volume de estoque e acesso direto a produto importado.

**Tela 5**
Hoje o propósito é simples. Unir experiência comercial, relacionamento próximo e soluções em importação, pra que empresas de qualquer porte consigam importar sem precisar virar especialista em comex.

**Tela 6**
A UpTrade é nova. A experiência em importação, não.
Vem falar com a gente. Agende pelo link.

---

### Serviços
Narrativa por serviço, sem preço, todos os 10 serviços presentes

**Tela 1**
Na UpTrade, a gente cuida da importação inteira. Do primeiro diagnóstico até a mercadoria na sua porta.
Passa pro lado pra ver o que a gente faz

**Tela 2**
Importação completa
Do fornecedor até a sua porta.
Você aprova, a gente executa cada etapa.

**Tela 3**
Importação por cotas
Sem precisar fechar um container inteiro.
Cota proporcional ao volume que você precisa.

**Tela 4**
Crédito para a operação
Mediante análise, dividimos o pagamento em etapas.
Pra quem não tem o capital todo disponível de uma vez.

**Tela 5**
Cotação internacional completa
Custo total, já com imposto e frete embutidos.
Apresentado antes de qualquer aprovação. Sem susto depois.

**Tela 6**
Verificação de fornecedor
Fábrica avaliada e negociada antes de qualquer pagamento.
Menos risco pra você desde o início.

**Tela 7**
Acompanhamento de produção, inspeção e embarque
Da fábrica ao navio ou avião, cada etapa acompanhada de perto.

**Tela 8**
Desembaraço aduaneiro e transporte nacional
A parte mais burocrática, resolvida.
Entrega com nota fiscal em qualquer endereço do Brasil.

**Tela 9**
Curadoria de produto
Não sabe o que importar? A gente cruza o que você já vende com o que tem demanda de verdade no mercado.

**Tela 10**
Qualquer origem
Ásia, América Latina, Europa e América do Norte.
Considerando o que faz mais sentido de custo e prazo pro seu produto.

**Tela 11**
Primeira importação da sua empresa?
A gente avalia se vale a pena antes de você gastar.

**Tela 12**
É isso que a gente faz. Do diagnóstico à entrega.
Agende pelo link. Sem enrolação.

---

### Como Funciona
As 5 etapas do processo, importação por cotas e por que importar com a UpTrade

**Tela 1**
Como funciona uma importação com a gente?
Cinco etapas. Sem você precisar aprender jargão de comex.

**Tela 2**
1. Diagnóstico
Você conta o que quer importar. A gente avalia se a operação fecha conta.

**Tela 3**
2. Cotação
Custo total já com imposto e frete embutidos. Sem surpresa depois.

**Tela 4**
3. Aprovação
Você aprova, a gente inicia o pagamento ao fornecedor.

**Tela 5**
4. Produção e embarque
A fábrica produz, a gente confere antes de embarcar e acompanha a viagem.

**Tela 6**
5. Liberação e entrega
Liberamos na alfândega e entregamos com nota fiscal, em qualquer endereço do Brasil.

**Tela 7**
Não precisa de container inteiro
A cota em container compartilhado existe pra quem quer importar mas não tem volume pra fechar uma operação sozinho.

**Tela 8**
+10 anos de mercado ensinam a enxergar fornecedor problemático antes de qualquer pagamento sair.
Não é sorte. É experiência.

**Tela 9**
Quer entender se sua operação fecha conta?
...
### FAQ
Dúvidas frequentes respondidas, cobre as perguntas do briefing e da LP
...
Atendimento personalizado pra quem quer importar, de um botão a um avião. Cuidamos da operação inteira.

**Tela 3**
Vocês importam só da China?
Não. Também atendemos América Latina, Ásia, Europa e América do Norte.
...
| 2 | Pra quem é a UpTrade, identificação de público e reforço de experiência |
...
**Fixado 3 — História, Propósito e Sócias (Carrossel)**
Por que escolher a UpTrade? Gerar identificação antes da decisão.
