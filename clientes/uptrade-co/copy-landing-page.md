...
**SUBHEADLINE:**
A UpTrade cuida da sua importação do primeiro diagnóstico até a mercadoria na sua porta. Cotação completa antes de qualquer aprovação, cota disponível pra quem ainda não tem volume de container fechado e crédito mediante análise pra quem precisa dividir o investimento.

**PROVA RÁPIDA (badges):**
- Atendimento personalizado, do diagnóstico à entrega
...
1. **Diagnóstico.** Você conta o que quer importar. A gente avalia se a operação fecha conta antes de qualquer outro passo.
2. **Cotação.** Buscamos e verificamos fornecedores e trazemos o custo total da operação, já com imposto e frete embutidos. Sem surpresa depois.
3. **Aprovação.** Você aprova, a gente inicia o pagamento ao fornecedor.
4. **Produção e embarque.** A fábrica produz, a gente confere antes de embarcar e acompanha a viagem.
5. **Liberação e entrega.** Liberamos na alfândega e entregamos com nota fiscal, em qualquer endereço do Brasil.

**Selo de transparência (faixa curta, sem texto longo):**
Operação documentada · Fornecedor verificado antes do pagamento · Nota fiscal na entrega

CTA: "Ver minha operação com esse processo" → WhatsApp
...
**SUBTÍTULO:**
A importação por cotas existe pra quem tem interesse em importar, mas não tem volume pra fechar uma operação sozinho.

**Como funciona, em termos simples:**
Em vez de comprar o container inteiro, você entra com a cota proporcional ao volume que precisa. O espaço é dividido com outros importadores, o custo também, e você mantém condição de custo equivalente à de um container fechado, de acordo com a estrutura de cada operação.

**Pra quem faz sentido:**
- Lojista que quer testar produto importado sem comprometer todo o capital de giro
- Distribuidor que quer diversificar o mix sem assumir volume de container fechado
- Quem nunca importou e quer entender o processo antes de assumir uma operação maior

**O que isso muda pra você:**
Menos capital travado em estoque parado, acesso a produto de origem sem esperar ter volume de container inteiro, e a possibilidade de crescer a operação aos poucos, conforme a demanda for confirmando.

CTA: "Quero saber se a cota funciona pra mim" → WhatsApp
...
**SUBTÍTULO:**
Fornecedor qualquer um encontra sozinho no Alibaba. O que garante que a operação chega inteira na sua porta é outra coisa.

**Os riscos de uma importação sem acompanhamento:**
- Câmbio que muda no meio da operação e altera o custo final
- Fornecedor que promete e não entrega o combinado
- Produção sem controle de qualidade, chegando fora do padrão esperado
- Carga retida na alfândega por documentação incompleta
- Atraso logístico sem ninguém pra avisar antes que vire problema
...
**SUBTÍTULO:**
Você não precisa entender de comércio exterior pra importar direito. Precisa de alguém que explique cada etapa antes de pedir sua aprovação.

**O que muda quando é sua primeira vez:**
Antes de qualquer coisa, avaliamos se a operação vale a pena pro seu caso. Se a conta não fechar, a gente fala isso antes de você gastar, não depois. Explicamos o processo em termos simples, sem jargão de comex, e você só aprova o que já entendeu.
...
**[Foto real de Vanessa e Daniela]**

A UpTrade nasceu em outubro de 2025, da união de Vanessa e Daniela, que já atuavam juntas na área comercial de uma importadora de utilidades domésticas antes de abrir a empresa. A experiência não começou com a UpTrade, veio de antes.

A proposta inicial era representação comercial e prospecção de clientes. Ao longo do processo, veio a demanda recorrente do mercado, empresas que queriam mais volume de estoque e acesso direto a produto importado. Foi aí que a UpTrade avançou pra importação direta, com o objetivo de oferecer mais competitividade, variedade e capacidade de atendimento.

Hoje, o propósito é unir experiência comercial, relacionamento próximo e soluções em importação, criando oportunidades mais competitivas pros clientes e parceiros.

A UpTrade é nova. A experiência em importação, não.
...
**SUBTÍTULO:**
`[Substituir quando a primeira leva de clientes autorizar por escrito o uso do nome/segmento]`

> Pendência crítica antes de publicar esta dobra. O briefing menciona clientes de referência ("Sim, vários, atendemos de pequenas a grandes redes"), mas nenhum nome foi autorizado por escrito. Publicar nome de cliente sem autorização expõe a UpTrade e a Strig. Duas opções até a autorização vir:
> 1. Trocar por prova sem nome: segmento, volume aproximado, tempo de relacionamento ("Distribuidor de utilidades domésticas, cliente desde `[mês/ano]`, aumentou o mix em `[X itens]`").
> 2. Substituir a dobra inteira por prova de processo (print de cotação anonimizado, linha do tempo de uma operação real, documentação do desembaraço) até o primeiro depoimento autorizado chegar.

CTA: "Quero ser o próximo case da UpTrade" → WhatsApp
...
**SUBTÍTULO:**
Conte o que você quer importar e a gente avalia se a operação fecha conta. Sem compromisso, sem letra miúda.

[Formulário: Nome + Empresa + WhatsApp + O que você quer importar]
...
**Texto:** Manda sua pergunta. Se a importação não fizer sentido pro seu caso agora, a gente fala isso antes de você gastar.
**Botão:** Falar com a UpTrade → `[link WhatsApp com mensagem pré-definida]`
